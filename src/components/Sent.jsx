...
const Sent = ({ userEmail }) => {
  ...
  if (loading) return <p className="text-center mt-4">Loading Sent Mails...</p>;
  ...
  const handleDeleteMail = async (id) => {
    try {
      const mailRef = ref(db, `sent/${cleanEmail}/${id}`);
  ...
  return (
    <div className="container mt-4">
      <h3 className="mb-3">✔️ Sent Emails</h3>
      ...
      {/* Modal to display the mail in detail*/}
